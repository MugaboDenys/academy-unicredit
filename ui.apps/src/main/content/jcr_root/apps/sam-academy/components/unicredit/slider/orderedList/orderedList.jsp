  ...
  <table is="coral-table" orderable id="<%=tableId%>">
    ...
    <thead is="coral-table-head">
      <tr is="coral-table-row">
        <th is="coral-table-headercell">Use the move icon on the right to drag up or down in order to reorder slides.</th>
    ...
    <tbody is="coral-table-body">
      ...
      %>
        <tr is="coral-table-row">
          ...
          <td is="coral-table-cell">
            <button is="coral-button" type="button" variant="minimal" icon="move" coral-table-roworder></button>
          </td>
        </tr>
      <%
      }
